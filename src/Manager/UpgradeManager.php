...
class UpgradeManager
{
 ...
 //               $sql = str_replace("CREATE TABLE ", "CREATE TABLE IF NOT EXISTS ", $sql);
  ...
  KEY `gibbonPersonID` (`gibbonPersonID`,`role`)
        ...
        $this->addSql('CREATE TABLE gibboni18n (`id` INT(4) UNSIGNED ZEROFILL AUTO_INCREMENT, code VARCHAR(5) NOT NULL, name VARCHAR(100) NOT NULL, version VARCHAR(10) DEFAULT NULL, active VARCHAR(1) DEFAULT \'Y\' NOT NULL, installed VARCHAR(1) DEFAULT \'N\' NOT NULL, systemDefault VARCHAR(1) DEFAULT \'N\' NOT NULL, dateFormat VARCHAR(20) NOT NULL, dateFormatRegEx LONGTEXT NOT NULL, dateFormatPHP VARCHAR(20) NOT NULL, rtl VARCHAR(1) DEFAULT \'N\' NOT NULL, PRIMARY KEY(`id`)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
  ...
  UNIQUE KEY `initials` (`initials`)
        ...
        $this->addSql('CREATE TABLE gibbonStudentEnrolment (gibbonStudentEnrolmentID INT(8) UNSIGNED ZEROFILL AUTO_INCREMENT, rollOrder INT(2), gibbonPersonID INT(10) UNSIGNED ZEROFILL, gibbonSchoolYearID INT(3) UNSIGNED ZEROFILL, gibbonYearGroupID INT(3) UNSIGNED ZEROFILL, gibbonRollGroupID INT(5) UNSIGNED ZEROFILL, INDEX gibbonPersonID (gibbonPersonID), INDEX gibbonSchoolYearID (gibbonSchoolYearID), INDEX gibbonYearGroupID (gibbonYearGroupID), INDEX gibbonRollGroupID (gibbonRollGroupID), INDEX gibbonPersonIndex (gibbonPersonID, AcademicYearID), PRIMARY KEY(gibbonStudentEnrolmentID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
