...
class UpgradeManager
{
 ...
 //               $sql = str_replace("CREATE TABLE ", "CREATE TABLE IF NOT EXISTS ", $sql);
  ...
  KEY `AcademicYearID` (`AcademicYearID`)
    ...
    `gibbonCourseClassID` int(8)  UNSIGNED ZEROFILL AUTO_INCREMENT,
  ...
  KEY `gibbonCourseID` (`gibbonCourseID`)
        ...
        $this->addSql('CREATE TABLE gibbonCourseClassMap (gibbonCourseClassMapID INT(8) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonCourseClassID INT(8) UNSIGNED ZEROFILL, gibbonRollGroupID INT(5) UNSIGNED ZEROFILL, gibbonYearGroupID INT(3) UNSIGNED ZEROFILL, INDEX IDX_97F9BC70A85AE4EC (gibbonRollGroupID), INDEX IDX_97F9BC70427372F (gibbonYearGroupID), UNIQUE INDEX gibbonCourseClassID (gibbonCourseClassID), PRIMARY KEY(gibbonCourseClassMapID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE `gibbonCourseClassPerson` (
  `gibbonCourseClassPersonID` int(10) UNSIGNED ZEROFILL AUTO_INCREMENT,
  ...
  KEY `gibbonPersonID` (`gibbonPersonID`,`role`)
        ...
        $this->addSql('CREATE TABLE gibbonInternalAssessmentColumn (gibbonInternalAssessmentColumnID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, groupingID INT(8) UNSIGNED ZEROFILL, name VARCHAR(20) NOT NULL, description LONGTEXT NOT NULL, type VARCHAR(50) NOT NULL, attachment VARCHAR(255) NOT NULL, attainment VARCHAR(1) DEFAULT \'Y\' NOT NULL, effort VARCHAR(1) DEFAULT \'Y\' NOT NULL, comment VARCHAR(1) DEFAULT \'Y\' NOT NULL, uploadedResponse VARCHAR(1) DEFAULT \'N\' NOT NULL, complete VARCHAR(1) NOT NULL, completeDate DATE DEFAULT NULL, viewableStudents VARCHAR(1) NOT NULL, viewableParents VARCHAR(1) NOT NULL, gibbonCourseClassID INT(8) UNSIGNED ZEROFILL, idAttainment INT(5) UNSIGNED ZEROFILL, idEffort INT(5) UNSIGNED ZEROFILL, gibbonPersonIDCreator INT(10) UNSIGNED ZEROFILL, gibbonPersonIDLastEdit INT(10) UNSIGNED ZEROFILL, INDEX IDX_E0A1D88AB67991E (gibbonCourseClassID), INDEX IDX_E0A1D88A2C639785 (idAttainment), INDEX IDX_E0A1D88AD395ACF8 (idEffort), INDEX IDX_E0A1D88AFF59AAB0 (gibbonPersonIDCreator), INDEX IDX_E0A1D88A519966BA (gibbonPersonIDLastEdit), PRIMARY KEY(gibbonInternalAssessmentColumnID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonInternalAssessmentEntry (gibbonInternalAssessmentEntryID INT(12) UNSIGNED ZEROFILL AUTO_INCREMENT, attainmentValue VARCHAR(10) DEFAULT NULL, attainmentDescriptor VARCHAR(100) DEFAULT NULL, effortValue VARCHAR(10) DEFAULT NULL, effortDescriptor VARCHAR(100) DEFAULT NULL, comment LONGTEXT DEFAULT NULL, response LONGTEXT DEFAULT NULL, gibbonInternalAssessmentColumnID INT(10) UNSIGNED ZEROFILL, gibbonPersonIDStudent INT(10) UNSIGNED ZEROFILL, gibbonPersonIDLastEdit INT(10) UNSIGNED ZEROFILL, INDEX IDX_B09C6F558B7A9BC (gibbonInternalAssessmentColumnID), INDEX IDX_B09C6F5F47CEFE0 (gibbonPersonIDStudent), INDEX IDX_B09C6F5519966BA (gibbonPersonIDLastEdit), PRIMARY KEY(gibbonInternalAssessmentEntryID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        ...
        $this->addSql('CREATE TABLE gibbonLog (gibbonLogID INT(16) UNSIGNED ZEROFILL AUTO_INCREMENT, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, title VARCHAR(50) NOT NULL, serialisedArray LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', ip VARCHAR(15) DEFAULT NULL, gibbonModuleID INT(4) UNSIGNED ZEROFILL, gibbonPersonID INT(10) UNSIGNED ZEROFILL, AcademicYearID INT(3) UNSIGNED ZEROFILL, INDEX IDX_C0122755CB86AD4B (gibbonModuleID), INDEX IDX_C0122755CC6782D6 (gibbonPersonID), INDEX IDX_C012275571FA7520 (AcademicYearID), PRIMARY KEY(gibbonLogID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE `gibbonMarkbookColumn` (
  `gibbonMarkbookColumnID` int(10) UNSIGNED ZEROFILL AUTO_INCREMENT,
  ...
  `gibbonMarkbookEntryID` int(12) UNSIGNED ZEROFILL AUTO_INCREMENT,
  ...
  KEY `gibbonMarkbookColumnID` (`gibbonMarkbookColumnID`)
        ...
        $this->addSql('CREATE TABLE gibbonMarkbookTarget (gibbonMarkbookTargetID INT(14) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonCourseClassID INT(8) UNSIGNED ZEROFILL, gibbonPersonIDStudent INT(10) UNSIGNED ZEROFILL, gibbonScaleGradeID INT(7) UNSIGNED ZEROFILL, INDEX IDX_916B28ECB67991E (gibbonCourseClassID), INDEX IDX_916B28ECF47CEFE0 (gibbonPersonIDStudent), INDEX IDX_916B28EC5E440573 (gibbonScaleGradeID), UNIQUE INDEX coursePerson (gibbonCourseClassID, gibbonPersonIDStudent), PRIMARY KEY(gibbonMarkbookTargetID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonMarkbookWeight (gibbonMarkbookWeightID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, type VARCHAR(50) NOT NULL, description VARCHAR(50) NOT NULL, reportable VARCHAR(1) DEFAULT \'Y\' NOT NULL, calculate VARCHAR(4) DEFAULT \'year\' NOT NULL, weighting NUMERIC(5, 2) NOT NULL, gibbonCourseClassID INT(8) UNSIGNED ZEROFILL, INDEX IDX_D0C95251B67991E (gibbonCourseClassID), PRIMARY KEY(gibbonMarkbookWeightID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
  ...
  KEY `IDX_30734075FF59AAB0` (`gibbonPersonIDCreator`)
        ...
        $this->addSql('CREATE TABLE gibbonRubric (gibbonRubricID INT(8) UNSIGNED ZEROFILL AUTO_INCREMENT, name VARCHAR(50) NOT NULL, category VARCHAR(50) NOT NULL, description LONGTEXT NOT NULL, active VARCHAR(1) NOT NULL, scope VARCHAR(10) NOT NULL, gibbonYearGroupIDList VARCHAR(255) NOT NULL, gibbonDepartmentID INT(4) UNSIGNED ZEROFILL, `gibbonScaleID` INT(5) UNSIGNED ZEROFILL, gibbonPersonIDCreator INT(10) UNSIGNED ZEROFILL, INDEX IDX_AFE9B66C6DFE7E92 (gibbonDepartmentID), INDEX IDX_AFE9B66C5F72BC3 (`gibbonScaleID`), INDEX IDX_AFE9B66CFF59AAB0 (gibbonPersonIDCreator), PRIMARY KEY(gibbonRubricID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonRubricCell (gibbonRubricCellID INT(11) UNSIGNED ZEROFILL AUTO_INCREMENT, contents LONGTEXT NOT NULL, gibbonRubricID INT(8) UNSIGNED ZEROFILL, gibbonRubricColumnID INT(9) UNSIGNED ZEROFILL, gibbonRubricRowID INT(9) UNSIGNED ZEROFILL, INDEX gibbonRubricID (gibbonRubricID), INDEX gibbonRubricColumnID (gibbonRubricColumnID), INDEX gibbonRubricRowID (gibbonRubricRowID), PRIMARY KEY(gibbonRubricCellID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonRubricColumn (gibbonRubricColumnID INT(9) UNSIGNED ZEROFILL AUTO_INCREMENT, title VARCHAR(20) NOT NULL, sequenceNumber INT(2), visualise VARCHAR(1) DEFAULT \'Y\' NOT NULL, gibbonRubricID INT(8) UNSIGNED ZEROFILL, gibbonScaleGradeID INT(7) UNSIGNED ZEROFILL, INDEX IDX_E31DA4325E440573 (gibbonScaleGradeID), INDEX gibbonRubricID (gibbonRubricID), PRIMARY KEY(gibbonRubricColumnID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonRubricEntry (gibbonRubricEntry INT(14) UNSIGNED ZEROFILL AUTO_INCREMENT, contextDBTable VARCHAR(255) NOT NULL COMMENT \'Which database table is this entry related to?\', contextDBTableID INT(20) UNSIGNED ZEROFILL, gibbonRubricID INT(8) UNSIGNED ZEROFILL, gibbonPersonID INT(10) UNSIGNED ZEROFILL, gibbonRubricCellID INT(11) UNSIGNED ZEROFILL, INDEX gibbonRubricID (gibbonRubricID), INDEX gibbonPersonID (gibbonPersonID), INDEX gibbonRubricCellID (gibbonRubricCellID), INDEX contextDBTable (contextDBTable), INDEX contextDBTableID (contextDBTableID), PRIMARY KEY(gibbonRubricEntry)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonRubricRow (gibbonRubricRowID INT(9) UNSIGNED ZEROFILL AUTO_INCREMENT, title VARCHAR(40) NOT NULL, sequenceNumber INT(2), gibbonRubricID INT(8) UNSIGNED ZEROFILL, gibbonOutcomeID INT(8) UNSIGNED ZEROFILL, INDEX IDX_96F9D13235479F6A (gibbonOutcomeID), INDEX gibbonRubricID (gibbonRubricID), PRIMARY KEY(gibbonRubricRowID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
  ...
  `gibbonStaffID` int(10) UNSIGNED ZEROFILL AUTO_INCREMENT,
  ...
  UNIQUE KEY `initials` (`initials`)
        ...
        $this->addSql('CREATE TABLE gibbonTTColumnRow (gibbonTTColumnRowID INT(8) UNSIGNED ZEROFILL AUTO_INCREMENT, name VARCHAR(12) NOT NULL, nameShort VARCHAR(4) NOT NULL, timeStart TIME NOT NULL, timeEnd TIME NOT NULL, type VARCHAR(8) NOT NULL, gibbonTTColumnID INT(6) UNSIGNED ZEROFILL, INDEX gibbonTTColumnID (gibbonTTColumnID), PRIMARY KEY(gibbonTTColumnRowID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE `gibbonTTDay` (
  `gibbonTTDayID` int(10) UNSIGNED ZEROFILL AUTO_INCREMENT,
  ...
  KEY `gibbonTTColumnID` (`gibbonTTColumnID`)
        ...
        $this->addSql('CREATE TABLE gibbonTTDayDate (gibbonTTDayDateID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, date DATE NOT NULL, gibbonTTDayID INT(10) UNSIGNED ZEROFILL, INDEX gibbonTTDayID (gibbonTTDayID), PRIMARY KEY(gibbonTTDayDateID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonTTDayRowClass (gibbonTTDayRowClassID INT(12) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonTTColumnRowID INT(8) UNSIGNED ZEROFILL, gibbonTTDayID INT(10) UNSIGNED ZEROFILL, gibbonCourseClassID INT(8) UNSIGNED ZEROFILL, facility INT(10) UNSIGNED ZEROFILL, INDEX IDX_C832432E375800E5 (gibbonTTDayID), INDEX gibbonCourseClassID (gibbonCourseClassID), INDEX facility (facility), INDEX gibbonTTColumnRowID (gibbonTTColumnRowID), PRIMARY KEY(gibbonTTDayRowClassID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonTTDayRowClassException (gibbonTTDayRowClassExceptionID INT(14) UNSIGNED ZEROFILL AUTO_INCREMENT, gibbonTTDayRowClassID INT(12) UNSIGNED ZEROFILL, gibbonPersonID INT(10) UNSIGNED ZEROFILL, INDEX IDX_D25EB853F501B20E (gibbonTTDayRowClassID), INDEX IDX_D25EB853CC6782D6 (gibbonPersonID), PRIMARY KEY(gibbonTTDayRowClassExceptionID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        ...
        $this->addSql('CREATE TABLE gibbonTTSpaceBooking (gibbonTTSpaceBookingID INT(12) UNSIGNED ZEROFILL AUTO_INCREMENT, foreignKey VARCHAR(30) DEFAULT \'gibbonFacilityID\' NOT NULL, foreignKeyID INT(10) UNSIGNED ZEROFILL, date DATE NOT NULL, timeStart TIME NOT NULL, timeEnd TIME NOT NULL, gibbonPersonID INT(10) UNSIGNED ZEROFILL, INDEX IDX_1A34AD71CC6782D6 (gibbonPersonID), PRIMARY KEY(gibbonTTSpaceBookingID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonTTSpaceChange (gibbonTTSpaceChangeID INT(12) UNSIGNED ZEROFILL AUTO_INCREMENT, date DATE NOT NULL, gibbonTTDayRowClassID INT(12) UNSIGNED ZEROFILL, facility INT(10) UNSIGNED ZEROFILL, gibbonPersonID INT(10) UNSIGNED ZEROFILL, INDEX facility (facility), INDEX IDX_772A323ECC6782D6 (gibbonPersonID), INDEX gibbonTTDayRowClassID (gibbonTTDayRowClassID), INDEX date (date), PRIMARY KEY(gibbonTTSpaceChangeID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonUnit (gibbonUnitID INT(10) UNSIGNED ZEROFILL AUTO_INCREMENT, name VARCHAR(40) NOT NULL, active VARCHAR(1) DEFAULT \'Y\' NOT NULL, description LONGTEXT NOT NULL, tags LONGTEXT NOT NULL, map VARCHAR(1) DEFAULT \'Y\' NOT NULL COMMENT \'Should this unit be included in curriculum maps and other summaries?\', ordering INT(2), attachment VARCHAR(255) NOT NULL, details LONGTEXT NOT NULL, license VARCHAR(50) DEFAULT NULL, sharedPublic VARCHAR(1) DEFAULT NULL, gibbonCourseID INT(8) UNSIGNED ZEROFILL, gibbonPersonIDCreator INT(10) UNSIGNED ZEROFILL, gibbonPersonIDLastEdit INT(10) UNSIGNED ZEROFILL, INDEX IDX_2CFBB258ACDCF59E (gibbonCourseID), INDEX IDX_2CFBB258FF59AAB0 (gibbonPersonIDCreator), INDEX IDX_2CFBB258519966BA (gibbonPersonIDLastEdit), PRIMARY KEY(gibbonUnitID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonUnitBlock (gibbonUnitBlockID INT(12) UNSIGNED ZEROFILL AUTO_INCREMENT, title VARCHAR(100) NOT NULL, type VARCHAR(50) NOT NULL, length VARCHAR(3) NOT NULL, contents LONGTEXT NOT NULL, teachersNotes LONGTEXT NOT NULL, sequenceNumber INT(4), gibbonUnitID INT(10) UNSIGNED ZEROFILL, INDEX IDX_7D624DA246DE4A3D (gibbonUnitID), PRIMARY KEY(gibbonUnitBlockID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonUnitClass (gibbonUnitClassID INT(12) UNSIGNED ZEROFILL AUTO_INCREMENT, running VARCHAR(1) DEFAULT \'N\' NOT NULL, gibbonUnitID INT(10) UNSIGNED ZEROFILL, gibbonCourseClassID INT(8) UNSIGNED ZEROFILL, INDEX IDX_1332C31F46DE4A3D (gibbonUnitID), INDEX IDX_1332C31FB67991E (gibbonCourseClassID), PRIMARY KEY(gibbonUnitClassID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonUnitClassBlock (gibbonUnitClassBlockID INT(14) UNSIGNED ZEROFILL AUTO_INCREMENT, title VARCHAR(100) NOT NULL, type VARCHAR(50) NOT NULL, length VARCHAR(3) NOT NULL, contents LONGTEXT NOT NULL, teachersNotes LONGTEXT NOT NULL, sequenceNumber INT(4), complete VARCHAR(1) DEFAULT \'N\' NOT NULL, gibbonUnitClassID INT(12) UNSIGNED ZEROFILL, gibbonPlannerEntryID INT(14) UNSIGNED ZEROFILL, gibbonUnitBlockID INT(12) UNSIGNED ZEROFILL, INDEX IDX_829289F1DEE4ED9C (gibbonUnitClassID), INDEX IDX_829289F1FE417281 (gibbonPlannerEntryID), INDEX IDX_829289F1858FFD1E (gibbonUnitBlockID), PRIMARY KEY(gibbonUnitClassBlockID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
        $this->addSql('CREATE TABLE gibbonUnitOutcome (gibbonUnitOutcomeID INT(12) UNSIGNED ZEROFILL AUTO_INCREMENT, sequenceNumber INT(4), content LONGTEXT NOT NULL, gibbonUnitID INT(10) UNSIGNED ZEROFILL, gibbonOutcomeID INT(8) UNSIGNED ZEROFILL, INDEX IDX_6D39303A46DE4A3D (gibbonUnitID), INDEX IDX_6D39303A35479F6A (gibbonOutcomeID), PRIMARY KEY(gibbonUnitOutcomeID)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB AUTO_INCREMENT = 1');
    }
    ...
    {
        $this->addSql('ALTER TABLE gibbonActivity ADD CONSTRAINT FOREIGN KEY (AcademicYearID) REFERENCES gibbonAcademicYear (id)');
        $this->addSql('ALTER TABLE gibbonActivityAttendance ADD CONSTRAINT FOREIGN KEY (gibbonActivityID) REFERENCES gibbonActivity (gibbonActivityID)');
        $this->addSql('ALTER TABLE gibbonActivityAttendance ADD CONSTRAINT FOREIGN KEY (gibbonPersonIDTaker) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonActivitySlot ADD CONSTRAINT FOREIGN KEY (gibbonActivityID) REFERENCES gibbonActivity (gibbonActivityID)');
        $this->addSql('ALTER TABLE gibbonActivitySlot ADD CONSTRAINT FOREIGN KEY (gibbonSpaceID) REFERENCES gibbonFacility (id)');
        $this->addSql('ALTER TABLE gibbonActivitySlot ADD CONSTRAINT FOREIGN KEY (gibbonDaysOfWeekID) REFERENCES gibbonDaysOfWeek (id)');
        $this->addSql('ALTER TABLE gibbonActivityStaff ADD CONSTRAINT FOREIGN KEY (gibbonActivityID) REFERENCES gibbonActivity (gibbonActivityID)');
        $this->addSql('ALTER TABLE gibbonActivityStaff ADD CONSTRAINT FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonActivityStudent ADD CONSTRAINT FOREIGN KEY (gibbonActivityID) REFERENCES gibbonActivity (gibbonActivityID)');
        $this->addSql('ALTER TABLE gibbonActivityStudent ADD CONSTRAINT FOREIGN KEY (gibbonPersonID) REFERENCES gibbonPerson (id)');
        $this->addSql('ALTER TABLE gibbonActivityStudent ADD CONSTRAINT FOREIGN KEY (gibbonActivityIDBackup) REFERENCES gibbonActivity (gibbonActivityID)');
        $this->addSql('ALTER TABLE gibbonActivityStudent ADD CONSTRAINT FOREIGN KEY (gibbonFinanceInvoiceID) REFERENCES gibbonFinanceInvoice (gibbonFinanceInvoiceID)');
